...
module top ;
    ...
    EdgeDetect_v1_0 EdgeDetect_rise (
        .d(Net_659),
        .det(Net_66),
        .clock(Net_3));
    defparam EdgeDetect_rise.EdgeType = 0;

    EdgeDetect_v1_0 EdgeDetect_fall (
        .d(Net_659),
        .det(Net_71),
        .clock(Net_3));
    defparam EdgeDetect_fall.EdgeType = 1;
	...
	wire [0:0] tmpOE__NETWORK_OUT_net;
	wire [0:0] tmpFB_0__NETWORK_OUT_net;
	wire [0:0] tmpIO_0__NETWORK_OUT_net;
	wire [0:0] tmpINTERRUPT_0__NETWORK_OUT_net;
	electrical [0:0] tmpSIOVREF__NETWORK_OUT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("c936bb4f-653d-4801-81c0-eb475c8e77dc"),
		  ...
		  .input_buffer_sel(2'b00))
		NETWORK_OUT
		 (.oe(tmpOE__NETWORK_OUT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__NETWORK_OUT_net[0:0]}),
		  .io({tmpIO_0__NETWORK_OUT_net[0:0]}),
		  .siovref(tmpSIOVREF__NETWORK_OUT_net),
		  .interrupt({tmpINTERRUPT_0__NETWORK_OUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__NETWORK_OUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
